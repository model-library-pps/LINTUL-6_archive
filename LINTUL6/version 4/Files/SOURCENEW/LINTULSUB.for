...
* ------------------------------------------------------------------------------*
      ...
      RNTLV= AMAX1( 0., RNSO* ATNLV/ NOTNUL(ATN) )
      RNTST= AMAX1( 0., RNSO* ATNST/ NOTNUL(ATN) )
      RNTRT= AMAX1( 0., RNSO* ATNRT/ NOTNUL(ATN) )
...
* ---------------------------------------------------------------------*
     ...
     $ RNFST,DVSDR,DRRT,DRST,RNLDLV,RNLDRT,RNLDST)
      ...
      RNLDLV= AMAX1( 0., RNFLV* DLV)
      RNLDRT= AMAX1( 0., RNFRT* DRRT)
      RNLDST= AMAX1( 0., RNFST* DRST)
