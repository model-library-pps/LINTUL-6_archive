...
${OBJECTDIR}/_ext/796314804/CLS.o: ../LIBRARY/CLS.for 
	...
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/796314804/CLS.o ../LIBRARY/CLS.for

${OBJECTDIR}/_ext/188910145/aux_routines.o: ../LIBRWOF/ttutil/aux_routines.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/188910145
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/188910145/aux_routines.o ../LIBRWOF/ttutil/aux_routines.for

${OBJECTDIR}/_ext/188910145/ttutil_win32.o: ../LIBRWOF/ttutil/ttutil_win32.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/188910145
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/188910145/ttutil_win32.o ../LIBRWOF/ttutil/ttutil_win32.for

${OBJECTDIR}/_ext/1472/Lintul6vr.o: ../Lintul6vr.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1472/Lintul6vr.o ../Lintul6vr.for

${OBJECTDIR}/_ext/1029452278/Cropv6.o: ../SOURCENEW/Cropv6.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/Cropv6.o ../SOURCENEW/Cropv6.for

${OBJECTDIR}/_ext/1029452278/Dailout6.o: ../SOURCENEW/Dailout6.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/Dailout6.o ../SOURCENEW/Dailout6.for

${OBJECTDIR}/_ext/1029452278/INITP6.o: ../SOURCENEW/INITP6.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/INITP6.o ../SOURCENEW/INITP6.for

${OBJECTDIR}/_ext/1029452278/LINTULSUB.o: ../SOURCENEW/LINTULSUB.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/LINTULSUB.o ../SOURCENEW/LINTULSUB.for

${OBJECTDIR}/_ext/1029452278/STOUT6.o: ../SOURCENEW/STOUT6.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/STOUT6.o ../SOURCENEW/STOUT6.for

${OBJECTDIR}/_ext/1029452278/SWEAF.o: ../SOURCENEW/SWEAF.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/SWEAF.o ../SOURCENEW/SWEAF.for

${OBJECTDIR}/_ext/1029452278/Timer6.o: ../SOURCENEW/Timer6.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/Timer6.o ../SOURCENEW/Timer6.for

${OBJECTDIR}/_ext/1029452278/WATBALS6.o: ../SOURCENEW/WATBALS6.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/WATBALS6.o ../SOURCENEW/WATBALS6.for

${OBJECTDIR}/_ext/1029452278/WEATHR.o: ../SOURCENEW/WEATHR.for 
	${MKDIR} -p ${OBJECTDIR}/_ext/1029452278
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/1029452278/WEATHR.o ../SOURCENEW/WEATHR.for
